...
from utils import read_data_file, creat_word_embedding, data_parse_for_lstm
...
def main(_):
    ...
    tr_data = data_parse_for_lstm(tr_revs, word_idx_map, FLAGS.max_sentence_len)

    te_revs, _ = read_data_file(FLAGS.test_file_path)
    te_data = data_parse_for_lstm(te_revs, word_idx_map, FLAGS.max_sentence_len)
    ...
    lstm.train(word_idx_map, w2v, tr_data, te_data)
